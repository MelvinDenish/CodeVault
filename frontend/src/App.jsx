...
function LandingPage() {
  ...
  return (
    <div style={{
      ...
      background: 'radial-gradient(ellipse at top, rgba(88,166,255,0.1) 0%, transparent 50%), radial-gradient(ellipse at bottom right, rgba(137,87,229,0.08) 0%, transparent 50%)',
    }}>
      <div className="fade-in" style={{ textAlign: 'center', maxWidth: '700px' }}>
        <div style={{
          width: '80px', height: '80px', borderRadius: '20px',
          background: 'var(--gradient-blue)', margin: '0 auto 28px',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontSize: '40px', fontWeight: 800, color: 'white',
          boxShadow: '0 12px 40px rgba(31,111,235,0.3)',
        }}>⟨⟩</div>
        ...
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center' }}>
          <a href="/register" className="btn btn-primary btn-lg"
            style={{ padding: '14px 32px', fontSize: '16px', boxShadow: '0 8px 30px rgba(31,111,235,0.3)' }}>
            🚀 Get Started Free
          </a>
